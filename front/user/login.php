<?php 
//对访问者的浏览器ua进行记录
//FILE_APPEND: 如果文件 user_brower_ua.text 已经存在，追加数据而不是覆盖。
file_put_contents("user_brower_ua.text",$_SERVER['REMOTE_ADDR'].PHP_EOL.$_SERVER['HTTP_USER_AGENT'].PHP_EOL.PHP_EOL,FILE_APPEND);
?> 
<?php
